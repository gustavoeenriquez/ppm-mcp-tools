...
uses
  ...
  MCPTool.WebSocket in 'MCPTool.WebSocket.pas';
...
begin
  ...
  try
    ...
    MCPTool.WebSocket.RegisterTools(MCPServer);
    MCPServer.Start;
    WriteLn(ErrOutput, '[mcp-websocket] ready.');
    while True do Sleep(1000);
  except
    on E: Exception do begin WriteLn(ErrOutput, '[mcp-websocket] Fatal: ' + E.Message); Halt(1); end;
  end;
end.
