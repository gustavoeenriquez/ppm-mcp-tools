...
uses
  ...
  MCPTool.Workflow in 'MCPTool.Workflow.pas';
...
begin
  ...
  try
    ...
    MCPTool.Workflow.RegisterTools(MCPServer);
    MCPServer.Start;
    WriteLn(ErrOutput, '[mcp-workflow] ready.');
    while True do Sleep(1000);
  except
    on E: Exception do begin WriteLn(ErrOutput, '[mcp-workflow] Fatal: ' + E.Message); Halt(1); end;
  end;
end.
